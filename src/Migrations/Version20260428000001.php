...
final class Version20260428000001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_channel ADD mailchimp_audience_id VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_channel DROP mailchimp_audience_id');
    }
}
