...
final class CartCreateHandlerTest extends TestCase
{
    ...
    public function test_upserts_products_before_cart_for_each_unique_product(): void
    {
        ...
        $handler = $this->buildHandler();
        $handler(new CartCreate(10));
    }

    private function buildHandler(): CartCreateHandler
    {
