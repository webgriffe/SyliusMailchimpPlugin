...
final class StoreUpdateHandlerTest extends TestCase
{
    ...
    public function test_upserts_store_with_audience_from_channel(): void
    {
        ...
        $handler = $this->buildHandler();
        $handler(new StoreUpdate(42));
    }

    private function buildHandler(): StoreUpdateHandler
    {
        return new StoreUpdateHandler(
